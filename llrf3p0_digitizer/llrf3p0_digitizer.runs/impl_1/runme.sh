...
HD_PWD='F:/Bachiman_FDrive/Projects/LLRF_EIC/nexys_digilent_llrf/llrf3p0_digitizer/llrf3p0_digitizer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log iq2mp_18bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source iq2mp_18bit.tcl -notrace
