...
HD_PWD='F:/Bachiman_FDrive/Projects/LLRF_EIC/nexys_digilent_llrf/llrf3p0_digitizer/llrf3p0_digitizer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log iq2mp_18bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source iq2mp_18bit.tcl
