...
set_property -dict { PACKAGE_PIN H22 IOSTANDARD LVCMOS25 DRIVE 12 SLEW FAST } [get_ports { lmk_le }]
set_property -dict { PACKAGE_PIN K21 IOSTANDARD LVCMOS25 DRIVE 12 SLEW FAST } [get_ports { lmk_sync }]
