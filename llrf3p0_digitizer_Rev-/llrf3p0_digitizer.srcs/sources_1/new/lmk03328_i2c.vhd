...
begin
	if(rising_edge(i2c_clock)) then
		case reg_cnt_q is
			...
			when 17 => clk_reg_data_d  <= 	x"2109";---------dac clock 250, vco 5000 div by 2 and 10
			when 18 => clk_reg_data_d  <= 	x"2230";
			when 19 => clk_reg_data_d  <= 	x"2300";
			when 20 => clk_reg_data_d  <= 	x"2418";---------adc clock 100, vco 5000 div by 2 and 25
			...
			when 26 => clk_reg_data_d  <= 	x"2A18";---------diagnostic clock 1 100 MHz, vco 5000 div by 2 and 25
			when 27 => clk_reg_data_d  <= 	x"2B18";
			when 28 => clk_reg_data_d  <= 	x"2C0F";---------diagnostic clock 
			...
			when 36 => clk_reg_data_d  <= 	x"3500";-----------R Divider 1
			when 37 => clk_reg_data_d  <= 	x"3600";
			when 38 => clk_reg_data_d  <= 	x"3701";
			when 39 => clk_reg_data_d  <= 	x"3802";----------out divider 2
			when 40 => clk_reg_data_d  <= 	x"3903";
			when 41 => clk_reg_data_d  <= 	x"3A00";
			when 42 => clk_reg_data_d  <= 	x"3B32";-----------N divider 50
			when 43 => clk_reg_data_d  <= 	x"3C00";
			when 44 => clk_reg_data_d  <= 	x"3D00";
			when 45 => clk_reg_data_d  <= 	x"3E00";-------------N divider fraction numerator 0
			when 46 => clk_reg_data_d  <= 	x"3F00";
			when 47 => clk_reg_data_d  <= 	x"4000";
			when 48 => clk_reg_data_d  <= 	x"4101";------------N divider fraction denominator 1
